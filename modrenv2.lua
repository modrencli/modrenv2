...
if tonumber(msg.sender.user_id) == tonumber(Themodrenv2) then
...
elseif tonumber(msg.sender.user_id) == tonumber(Themodrenv2) then
...
local post_count = tonumber(Redis:get(Themodrenv2.."modrenv2:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Themodrenv2.."modrenv2:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
...
Redis:setex(Themodrenv2.."modrenv2:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
...
if tonumber(Redis:get(Themodrenv2.."modrenv2:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Themodrenv2.."modrenv2:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Themodrenv2.."modrenv2:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if tonumber(Themodrenv2) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(Themodrenv2) then 
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
download('https://raw.githubusercontent.com/modren/modrenv2/main/modrenv2.lua','modrenv2.lua')
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Themodrenv2..'modrenv2:Num:Add:Bot') or 0)) and not msg.ControllerBot then
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(Themodrenv2.."modrenv2:Name:Bot") or "بلاك بينك")..
